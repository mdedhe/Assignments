...
namespace Assignments
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Question Number 7th closestNumber()
            int[] inputarry = { -20, -3916237, -357920, -3620601, 7374819, -7330761, 30, 6246457, -6461594, 266854, -520, -470 };
            Console.WriteLine("Find the closest Number.");
            Console.WriteLine(string.Join(" ", inputarry));
            int[] closestArray = closestNumbers(inputarry);
            Console.WriteLine("The closestArray is ");
            Console.WriteLine(string.Join(" ", closestArray));
            Console.ReadKey(true);

            //Question Number 8th dayOftheProgrammer
            Console.WriteLine("The dayOf the programmer");
            int year = 2017;
            string finalString = dayOfProgrammer(year);
            Console.WriteLine("Day of the programmer "+finalString);
            Console.ReadKey(true);
        }
        ...
        static string getTheDateJulian(int year) // method for date of Julian year
        {
            String finalDate = "";
            //on the basis of sum of months in Leap year
        ...
        static string getTheDate1918(int year)// method to get date
        {
            String finalDate = "";
        ...
        static bool isLeapYearJulian(int year)// method for checking Julian year
        {
            bool flag = false;
        ...
        static bool isLeapYearGregorian(int year)// method for checking Gregorian year
        {
            bool flag = false;
